...
### This enables us to show image with Sdl2 graphics library.
...
```bash gcc iv.c -o iv.exe -I "C:\SDL\x86_64-w64-mingw32\include" -L "C:\SDL\x86_64-w64-mingw32\lib" -lSDL3
```
